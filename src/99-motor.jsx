...
const REGRAS_EXAME = {
  ...
  multiplaEscolha: { valor: 40, origem: "oficial", nota: "Página oficial da CPA: 40 questões de múltipla escolha contextualizada. O edital 13.4 acrescenta que a prova também traz CASES — que são múltiplas escolhas encadeadas e entram nessas 40." },
  itensArvore: { valor: 10, origem: "oficial", nota: "Página oficial da CPA: 10 questões relacionadas a árvore de decisão (o edital 13.4 chama de \"árvore de diálogo\"). A ANBIMA conta QUESTÕES, não árvores: aqui são 10 decisões, tiradas de atendimentos inteiros a partir da primeira fala." },
